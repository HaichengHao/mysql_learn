...
-- 同步goods表中的数据到brands表当中
insert into brands(name)(select brand_name from goods group by brand_name);

--更新商品信息数据
--1先内连接两张表goods和brands
select * from goods inner join brands on goods.brand_name=brands.name;
'''
mysql> select * from goods inner join brands on goods.brand_name=brands.name;
+----+---------------------------------------+---------+------------+-----------+------------------+------------------------+----+--------+
| id | name                                  | cate_id | brand_name | price     | is_show          | is_saleoff             | id | name   |
+----+---------------------------------------+---------+------------+-----------+------------------+------------------------+----+--------+
|  1 | r510vc 15.6英寸笔记本                 |       1 | 华硕       |  3399.000 | 0x01             | 0x00                   |  1 | 华硕   |
|  2 | y400n 14.0英寸笔记本电脑              |       1 | 联想       |  4999.000 | 0x01             | 0x00                   |  2 | 联想   |
|  3 | g150th 15.6英寸游戏本                 |       2 | 雷神       |  8499.000 | 0x01             | 0x00                   |  3 | 雷神   |
|  4 | x550cc 15.6英寸笔记本                 |       1 | 华硕       |  2799.000 | 0x01             | 0x00                   |  1 | 华硕   |
|  5 | x240 超极本                           |       3 | 联想       |  4880.000 | 0x01             | 0x00                   |  2 | 联想   |
|  6 | u330p 13.3英寸超极本                  |       3 | 联想       |  4299.000 | 0x01             | 0x00                   |  2 | 联想   |
|  7 | svp13226scb 触控超极本                |       3 | 索尼       |  7999.000 | 0x01             | 0x00                   |  4 | 索尼   |
|  8 | ipad mini 7.9英寸平板电脑             |       4 | 苹果       |  1998.000 | 0x01             | 0x00                   |  5 | 苹果   |
|  9 | ipad air 9.7英寸平板电脑              |       4 | 苹果       |  3388.000 | 0x01             | 0x00                   |  5 | 苹果   |
| 10 | ipad mini 配备 retina 显示屏          |       4 | 苹果       |  2788.000 | 0x01             | 0x00                   |  5 | 苹果   |
| 11 | ideacentre c340 20英寸一体电脑        |       5 | 联想       |  3499.000 | 0x01             | 0x00                   |  2 | 联想   |
| 12 | vostro 3800-r1206 台式电脑            |       5 | 戴尔       |  2899.000 | 0x01             | 0x00                   |  6 | 戴尔   |
| 13 | imac me086ch/a 21.5英寸一体电脑       |       5 | 苹果       |  9188.000 | 0x01             | 0x00                   |  5 | 苹果   |
| 14 | at7-7414lp 台式电脑 linux ）          |       5 | 宏碁       |  3699.000 | 0x01             | 0x00                   |  7 | 宏碁   |
| 15 | z220sff f4f06pa工作站                 |       6 | 惠普       |  4288.000 | 0x01             | 0x00                   |  8 | 惠普   |
| 16 | poweredge ii服务器                    |       6 | 戴尔       |  5388.000 | 0x01             | 0x00                   |  6 | 戴尔   |
| 17 | mac pro专业级台式电脑                 |       6 | 苹果       | 28888.000 | 0x01             | 0x00                   |  5 | 苹果   |
| 18 | hmz-t3w 头戴显示设备                  |       7 | 索尼       |  6999.000 | 0x01             | 0x00                   |  4 | 索尼   |
| 19 | 商务双肩背包                          |       7 | 索尼       |    99.000 | 0x01             | 0x00                   |  4 | 索尼   |
| 20 | x3250 m4机架式服务器                  |       6 | ibm        |  6888.000 | 0x01             | 0x00                   |  9 | ibm    |
| 21 | 商务双肩背包                          |       7 | 索尼       |    99.000 | 0x01             | 0x00                   |  4 | 索尼   |
'''

--2更新内连接的两张表中的子表goods的brand_name的值，将其设置为brands表的id
...
+----+---------------------------------------+---------+------------+-----------+------------------+------------------------+
|  1 | r510vc 15.6英寸笔记本                 |       1 | 1          |  3399.000 | 0x01             | 0x00                   |
|  2 | y400n 14.0英寸笔记本电脑              |       1 | 2          |  4999.000 | 0x01             | 0x00                   |
|  3 | g150th 15.6英寸游戏本                 |       2 | 3          |  8499.000 | 0x01             | 0x00                   |
|  4 | x550cc 15.6英寸笔记本                 |       1 | 1          |  2799.000 | 0x01             | 0x00                   |
|  5 | x240 超极本                           |       3 | 2          |  4880.000 | 0x01             | 0x00                   |
|  6 | u330p 13.3英寸超极本                  |       3 | 2          |  4299.000 | 0x01             | 0x00                   |
|  7 | svp13226scb 触控超极本                |       3 | 4          |  7999.000 | 0x01             | 0x00                   |
|  8 | ipad mini 7.9英寸平板电脑             |       4 | 5          |  1998.000 | 0x01             | 0x00                   |
|  9 | ipad air 9.7英寸平板电脑              |       4 | 5          |  3388.000 | 0x01             | 0x00                   |
| 10 | ipad mini 配备 retina 显示屏          |       4 | 5          |  2788.000 | 0x01             | 0x00                   |
| 11 | ideacentre c340 20英寸一体电脑        |       5 | 2          |  3499.000 | 0x01             | 0x00                   |
| 12 | vostro 3800-r1206 台式电脑            |       5 | 6          |  2899.000 | 0x01             | 0x00                   |
| 13 | imac me086ch/a 21.5英寸一体电脑       |       5 | 5          |  9188.000 | 0x01             | 0x00                   |
| 14 | at7-7414lp 台式电脑 linux ）          |       5 | 7          |  3699.000 | 0x01             | 0x00                   |
| 15 | z220sff f4f06pa工作站                 |       6 | 8          |  4288.000 | 0x01             | 0x00                   |
| 16 | poweredge ii服务器                    |       6 | 6          |  5388.000 | 0x01             | 0x00                   |
| 17 | mac pro专业级台式电脑                 |       6 | 5          | 28888.000 | 0x01             | 0x00                   |
| 18 | hmz-t3w 头戴显示设备                  |       7 | 4          |  6999.000 | 0x01             | 0x00                   |
| 19 | 商务双肩背包                          |       7 | 4          |    99.000 | 0x01             | 0x00                   |
| 20 | x3250 m4机架式服务器                  |       6 | 9          |  6888.000 | 0x01             | 0x00                   |
| 21 | 商务双肩背包                          |       7 | 4          |    99.000 | 0x01             | 0x00                   |
+----+---------------------------------------+---------+------------+-----------+------------------+------------------------+
21 rows in set (0.00 sec)
'''
--4修改goods表的结构，将brand_name变化为brand_id
